...
parameter_criterion = st.sidebar.select_slider('Performance measure (criterion)', options=['squared_error','friedman_mse','poisson', 'absolute_error'])
...
def build_model(df):
    ...
    # Updated access for x and y
    x = grid_pivot.columns.values  # This gets all the n_estimators values
    y = grid_pivot.index.values    # This gets all the max_features values
    z = grid_pivot.values           # This gets the R2 values as a 2D array
